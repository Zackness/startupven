...
import { ScaleHeroCanvas } from "./components/scale-hero-canvas";

export const metadata = {
  title: `Scale | Servicios | ${BRAND_NAME}`,
  description: "Sistemas a medida, SaaS, multi-tenant e infraestructura escalable. Arquitectura premium.",
};

const features = [
  { icon: Code2, title: "SaaS a medida", desc: "Desarrollo de software como servicio. Lógica de negocio personalizada." },
  { icon: GitBranch, title: "Multi-tenant", desc: "Arquitectura para múltiples clientes o organizaciones en una sola base." },
  { icon: Server, title: "Infraestructura", desc: "Escalable y mantenible. APIs e integraciones avanzadas." },
];

export default function ServiciosScalePage() {
  return (
    <div className="min-h-screen">
      <div className="border-t border-[var(--border)] px-6 py-12 sm:px-8 sm:py-16">
        <div className="mx-auto max-w-4xl">
          <Link href="/servicios" className="text-sm font-medium text-[var(--muted-foreground)] hover:text-[var(--foreground)]">
            ← Servicios
          </Link>
        </div>
      </div>
      ...
      <section className="relative mx-auto max-w-4xl px-4 pb-16 sm:px-6 sm:pb-24">
        ...
        <div className="relative z-10 flex min-h-[320px] flex-col items-center justify-center py-8 text-center sm:min-h-[360px] sm:py-10">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-[var(--muted-foreground)] leading-relaxed sm:mt-5">
            Sistemas a medida, SaaS e infraestructura escalable. Para startups tecnológicas y organizaciones con procesos complejos.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3 sm:mt-10">
            <Button asChild size="lg" className="rounded-xl bg-[var(--primary)] text-[var(--primary-foreground)] hover:opacity-90">
              <Link href="/contacto">Solicitar Scale</Link>
            </Button>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            {features.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-6 text-center transition-colors hover:border-[var(--foreground)]/10"
              >
      ...
      <section className="px-6 py-16 sm:px-8 sm:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-[var(--muted-foreground)]">
            Scale es arquitectura premium. Hablemos de tu sistema.
          </p>
